...
segments = [
  # ("BODY", "fakedata|2022-05-25--14-25-20--0"),
  # ("HYUNDAI", "fakedata|2022-01-20--17-49-04--0"),
  # ("TOYOTA", "fakedata|2022-04-29--15-57-12--0"),
  # ("TOYOTA2", "fakedata|2022-04-29--16-08-01--0"),
  # ("TOYOTA3", "fakedata|2022-04-29--16-17-39--0"),  # orig
  ("TOYOTA3", "fakedata|2022-05-25--15-45-37--0"),  # regen
...
if __name__ == "__main__":
  ...
  full_test = False  # all(len(x) == 0 for x in (args.whitelist_procs, args.whitelist_cars, args.blacklist_procs, args.blacklist_cars, args.ignore_fields, args.ignore_msgs))
  ...
  for car_brand, segment in segments:
    ...
    for cfg in CONFIGS:
      ...
      if not args.upload_only:
        ...
        results[segment][cfg.proc_name], log_msgs = test_process(cfg, lr, ref_log_path, args.ignore_fields, args.ignore_msgs)
